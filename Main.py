...
def main(experiment, dataset, epochs, learning_rate, results_dir_base, noise, reg_val=None, l1_lambda=1e-5, l2_lambda=1e-4, drop_rate=0.2, esp=10):
    ...
    if experiment == 'base':
        ...
        # Train with the combined augmentation and early stopping
        trainer.train(epochs=epochs, experiment_name=f'combo_{dataset.lower()}')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--experiment', type=str, default='base',
                        choices=['base', 'all', 'combo'] + list(augmentations),
